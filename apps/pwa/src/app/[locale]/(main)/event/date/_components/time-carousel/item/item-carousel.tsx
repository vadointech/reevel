...
export const IosPickerItem: React.FC<PropType> = (props) => {
    ...
    return (
        <div className={styles.embla__ios__picker}>
            <div className={styles.embla__ios__picker__scene} ref={rootNodeRef}>
                <div
                    className={`
                        ${styles.embla__ios__picker__viewport} 
                        ${styles[`embla__ios__picker__viewport__perspective_${perspective}`]}
                    `}
                    ref={emblaRef}
                >
                    <div className={styles.embla__ios__picker__container}>
                        {slides.map((_, index) => (
                            <div
                                className={styles.embla__ios__picker__slide}
                                key={index}
                            >
                                {index}
                            </div>
            ...
            <div className={styles.embla__ios__picker__label}>{label}</div>
        </div>
    )
}
